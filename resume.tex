	...
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			{\scriptsize { \footnotesize{\newline{}\textbf{Concentration:}
                Graphics \& Information Internetworks
			}}}
...
\section{Experience}
	\resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            {May 2022 -- Jul. 2022}
        \resumeItemListStart
            \resumeItem{Assisted users in identifying issues and adjusting machine algorithms
                efficiently by developing an error analysis visualization tool for
                machine learning models using React, Flask, and Pandas}
            \resumeItem{Designed and implemented data architecture to allow the tool to
                communicate seamlessly with the database}
        \resumeItemListEnd
        \resumeSubheading
...
\section{Projects}
    ...
    \vspace{1mm}
        \resumeProjectHeading
            {Martian Defense 3000}
            {Java, JavaFX, JUnit, Figma}
            {Sept. 2021}
            \resumeItemListStart
                \resumeItem{Created a space themed tower defense game with 4 other classmates}
                \resumeItem{Designed and implemented multiple game screens and sprites}
                \resumeItem{Wrote a variety of JUnit tests to test correct functionality
                    of the game}
            \resumeItemListEnd
        \resumeProjectHeading
            {gamelettr}
        ...
        \resumeProjectHeading
            ...
            {Oct. 2020}
            \resumeItemListStart
                \resumeItem{Contributed to a decision tree anomaly detection model
