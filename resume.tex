	...
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			{\scriptsize { \footnotesize{\newline{}\textbf{Courses:}
                ...
                Systems and Networks, Databases,
...
\section{Experience}
	\resumeSubHeadingListStart
        \resumeSubheading
            {Amazon Web Services}
            {East Palo Alto, CA}
            {OpenSearch Ingestion - Software Development Intern}
            {May 2023 -- Aug 2023}
            \resumeItemListStart
                \resumeItem{Improved data ingestion tool's capabilities to enrich and transform
                data and increased data processing power}
                \resumeItem{Enhanced customer ability to collect observability data
                by developing new configurations for the key-value processor}
        ...
        \resumeItemListStart
            ...
            across different majors, credit hours, graduation rates, and more}
            \resumeItem{Iterated and improved pre-existing dashboard designs
            in the provost system}
